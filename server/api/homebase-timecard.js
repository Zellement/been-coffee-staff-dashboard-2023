export default defineEventHandler(async (event) => {
    ...
    try {
        const response = await fetch(`https://api.joinhomebase.com/locations/${process.env.HOMEBASE_LOCATION_WILLINGTON_ID}/timecards/${query.timecardId}?start_date=${today}&end_date=${today}`, {
            method: 'GET',
            headers: {
